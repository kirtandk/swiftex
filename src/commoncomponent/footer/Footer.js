      ...
      <Container sx={{ maxWidth: { lg: "xl", xs: "lg" } }}>
        <Box py={5}>
          ...
          <Box sx={{pt:{md:10,xs:0}}}>
            <Grid container item xs={12} display={"flex"} justifyContent={"center"} py={5} sx={{ borderBottom: "1px solid black" }} >
              <Grid item xs={12} md={3} sx={{ display: "flex", justifyContent: { md: "start", xs: "center" }, paddingTop: { md: 0, xs: 5 }, }}>
                <Box>
                  ...
                  >
                    {/* <Box sx={{ backgroundColor: "#21324D", padding: "2px 2px", borderRadius: "5px", display: "flex" }}>
                            <TwitterIcon sx={{ color: "white",fontSize:"1.9rem",cursor:"pointer",}} />
                          </Box>
                          <Box sx={{ backgroundColor: "#21324D", padding: "2px 2px", borderRadius: "5px", display: "flex" }}>
                            <InstagramIcon sx={{ color: "white",fontSize:"1.9rem",cursor:"pointer",}} />
                          </Box>
                          <Box sx={{ backgroundColor: "#21324D", padding: "2px 3px", borderRadius: "5px", display: "flex" }}>
                            <i className="fa-brands fa-linkedin-in" style={{ color: "white", fontSize: "1.9rem",cursor:"pointer",}}> </i>
                          </Box>
                          <Box sx={{ backgroundColor: "#21324D", padding: "2px 6px", borderRadius: "5px", display: "flex" }}>
                            <i className="fa-brands fa-facebook-f" style={{ color: "white", fontSize: "1.9rem",cursor:"pointer",}}> </i>
                          </Box> */}
              ...
              <Grid  item xs={12} md={2} sx={{ display: "flex", justifyContent: { md: "start", xs: "center" }, paddingTop: { md: 0, xs: 5 },}} >
                <Box
                  sx={{
              ...
              <Grid item xs={6} md={2} sx={{ display: "flex", justifyContent: { md: "start", xs: "center" }, paddingTop: { md: 0, xs: 5 },  }} >
                <Box>
                  <Typography
                    mb={1}
                    sx={{
            ...
            <Box mt={4} sx={{ display: { md: "none", xs: "flex" } }} gap={2} alignItems={"center"} justifyContent={"center"} flexWrap="wrap">
              <Box
                sx={{
                  backgroundColor: "#21324D",
                  padding: "2px 2px",
