    ...
    <Box py={5}>
         ...
         <Container  sx={{maxWidth:{lg:"xl", sm:"lg"}}}>
               <Box sx={{padding:{md:"30px",xs:0}}}>
                   ...
                   <Box pt={1}>
                     {/* <Typography sx={{color:"white",fontSize:{md:"24px",sm:"20px",xs:"18px"},fontWeight:"400",fontFamily:"'Prompt',sans-serif",textAlign:"center"}}>With a well-established network of trusted suppliers, manufacturers, and distributors across the world,we ensure that your supply chain runs smoothly and efficiently. </Typography> */}
                   </Box>
