        ...
        <Container sx={{ maxWidth: { lg: "xl", sm: "lg" } }}>
          ...
          <Grid container xs={12} item spacing={5} sx={{display:"flex", justifyContent:"center"}}>
            <Grid item xs={12} md={10} >
              <img
                src={Blog?.imgSrc}
                style={{ width: "100%", height: "800px", borderRadius: "40px" }}
                alt=""
              />
              <Box>
                <Typography
            ...
            {/* <Grid
              ...
              lg={4}
              sx={{
                marginLeft: { lg: "40px", md: "40px", sm: "0px", xs: "0px" },
                display: "flex",
                alignItems: "center",
                height: { lg: "550px", md: "550px", sm: "300px", xs: "350px" },
              }}
            >
              <Box>
                <Typography
                ...
                >
                  Sed ut perspiciatis unde omnis iste natus err or sit
